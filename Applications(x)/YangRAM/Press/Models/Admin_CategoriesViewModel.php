...
class Admin_CategoriesViewModel extends \PM\_2\BaseCRUDViewModel {
	public static
	...
	protected static function __viewWhere(){
        ...
        return "`tablename` = 'news' AND `SK_IS_RECYCLED` = '0'";
	}
	...
	protected function buildTableRows($basedir, $items = []){
        ...
        foreach($items as $index=>$item){
            ...
            $rows[] = [
                '__index'		=>	[$index + 1],
                'name'		=>	[$item->name, $itemurl, false],
                'parent'	=>	$parent,
                'desc'		=>	[$item->description],
                '__ops'		=>	['<a href="'.$itemurl.'">编辑</a> | <a data-onclick="delete" data-submit-href="'.$itemurl.'" href="javascript:;">移除</a>']
            ];
        }
        return $rows;
	}
