...
class RowsController extends \AF\Controllers\BaseResourcesController {
    ...
    $__sorts = [
        ...
        'gldcd'  =>  TableRowMetaModel::GLDCD,
        'gldca'  =>  TableRowMetaModel::GLDCA,
        'glacd'  =>  TableRowMetaModel::GLACD,
        'glaca'  =>  TableRowMetaModel::GLACA,
        'gldpd'  =>  TableRowMetaModel::GLDPD,
        'gldpa'  =>  TableRowMetaModel::GLDPA,
        'glapd'  =>  TableRowMetaModel::GLAPD,
        'glapa'  =>  TableRowMetaModel::GLAPA,
        'gldtd'  =>  TableRowMetaModel::GLDTD,
        'gldta'  =>  TableRowMetaModel::GLDTA,
        'glatd'  =>  TableRowMetaModel::GLATD,
        'glata'  =>  TableRowMetaModel::GLATA,

        'gldtd_pinyin'  =>  TableRowMetaModel::GLDTD_GBK,
        'gldta_pinyin'  =>  TableRowMetaModel::GLDTA_GBK,
        'glatd_pinyin'  =>  TableRowMetaModel::GLATD_GBK,
        'glata_pinyin'  =>  TableRowMetaModel::GLATA_GBK
    ],
