                ...
                click(event) {
                    ...
                    if (YangRAM.attr(row, 'state') != 'off') {
                        ...
                        var handlers = {
                            ...
                            display2D() {
                                System.MagicCube.show(7000, () => { alert('Loading Animation Demo displays Completely!'); }, '2d');
                            },
                            display3D() {
                                System.MagicCube.show(7000, () => { alert('Loading Animation Demo displays Completely!'); }, '3d');
                            },
                            Logoff() {
