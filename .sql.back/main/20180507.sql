...
--
-- Table structure for table `ni_1008_brands`
--
...
--
-- Dumping data for table `ni_1008_brands`
--
...
(0, 5, 2, '出口产品', '/applications/uploads/files/d3ff99c7a3aafab915203534435a9ec0a3f3026.jpg', '出口产品');

-- --------------------------------------------------------

--
-- Table structure for table `ni_1008_categories`
--
...
--
-- Dumping data for table `ni_1008_categories`
--
...
--
-- Table structure for table `ni_1008_category_attrs`
--
...
--
-- Dumping data for table `ni_1008_category_attrs`
--
...
--
-- Table structure for table `ni_1008_options`
--

CREATE TABLE `ni_1008_options` (
...
--
-- Dumping data for table `ni_1008_options`
--

INSERT INTO `ni_1008_options` (`option_name`, `option_value`, `autoload`) VALUES
('show_buy_link_on_pagesplugin', 'yes', 1);

-- --------------------------------------------------------

--
-- Table structure for table `ni_1008_productions`
--
...
--
-- Dumping data for table `ni_1008_productions`
--
...
(28, '', '玛德琳夹心饼干（芒果味）360g', '', 2, 1, 9, '/applications/uploads/files/21317ffa88289fa415223115745abca196d4e9b.jpg', '360克', '[]', '<div><span style=\"color: rgb(0, 0, 0); font-family: Simsun; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: normal;\">采用独特的加工工艺，玛德琳饼干格外酥脆，入口即喷发出淡淡的自然小麦香气，搭配风味浓郁的芒果味夹心，口感丰富，齿颊留香。独立小包装，锁定风味，安全卫生，携带方便。</span><br></div>', '2018-03-23 10:12:10', 'https://detail.tmall.com/item.htm?spm=a1z10.3-b-s.w4011-15652746195.73.580d6e8ek6kQRc&id=564334773582&rn=73741f19863d0fcbad9ab48ca67a262f&abbucket=12', 5, 0, 1),
...
(6, NULL, '玛德琳夹心饼干(椰子味)2', NULL, 2, 2, 2, '/applications/uploads/files/a47e00d3d3c0455015207782545aa53c0e46f28.jpg', '540g×10罐/箱', NULL, '当奶油恋上芝士，香浓的爱意沉浸在芝士的丝滑里，却因同根生而被命运阻隔，于是这份恋少了些许甜腻，多了一丝酸楚。幸好，有相思豆的铺撒，让原本凄凉的爱情多了无限温暖。', '0000-00-00 00:00:00', NULL, 5, 0, 1),
...
(8, NULL, '玛德琳夹心饼干(椰子味)4', NULL, 2, 2, 4, '/applications/uploads/files/a47e00d3d3c0455015207781805aa53bc49ab76.jpg', '540g×10罐/箱', NULL, '当奶油恋上芝士，香浓的爱意沉浸在芝士的丝滑里，却因同根生而被命运阻隔，于是这份恋少了些许甜腻，多了一丝酸楚。幸好，有相思豆的铺撒，让原本凄凉的爱情多了无限温暖。', '0000-00-00 00:00:00', NULL, 5, 0, 1),
(9, NULL, '玛德琳夹心饼干(椰子味)1', NULL, 2, 2, 2, '/applications/uploads/files/a47e00d3d3c0455015207784455aa53ccd5785d.jpg', '540g×10罐/箱', NULL, '当奶油恋上芝士，香浓的爱意沉浸在芝士的丝滑里，却因同根生而被命运阻隔，于是这份恋少了些许甜腻，多了一丝酸楚。幸好，有相思豆的铺撒，让原本凄凉的爱情多了无限温暖。', '0000-00-00 00:00:00', NULL, 5, 0, 1),
...
(39, '', '玛德琳夹心饼干（椰子味）360g', '', 2, 1, 9, '/applications/uploads/files/02dcf9df8453b54415223114615abca126617d2.jpg', '360g', '[]', '<div><font color=\"#000000\" face=\"Simsun\"><span style=\"font-size: 16px;\">采用独特的加工工艺，玛德琳饼干格外酥脆，入口即喷发出淡淡的自然小麦香气，搭配清甜柔滑的椰子味夹心，口感丰富，齿颊留香。独立小包装，锁定风味，安全卫生，携带方便。</span></font><br></div>', '2018-03-23 14:14:27', 'https://detail.tmall.com/item.htm?spm=a1z10.3-b-s.w4011-15652746195.73.580d6e8ek6kQRc&id=564334773582&rn=73741f19863d0fcbad9ab48ca67a262f&abbucket=12', 5, 0, 1),
...
(65, '', '柠檬味夹心饼干360g', '', 2, 1, 15, '/applications/uploads/files/0d69bf0afbd13ef315223122465abca43757150.jpg', '360g', '[]', '<div style=\"color: rgb(0, 0, 0); font-family: Simsun; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: normal;\">精选优质阳光小麦粉，苏打饼香脆不粘牙，搭配柔滑清新的柠檬味夹心，更具风味。独立小包装，锁定风味，安全卫生，携带方便。</div>', '2018-03-29 16:30:36', 'https://detail.tmall.com/item.htm?spm=a1z10.3-b-s.w4011-15652746195.46.580d6e8ek6kQRc&id=542618977609&rn=73741f19863d0fcbad9ab48ca67a262f&abbucket=12', 5, 0, 1),
(66, '', '乳酪夹心饼干360g', '', 2, 1, 15, '/applications/uploads/files/160ca776cb3cb64115223122725abca450b7eb5.jpg', '360g', '[]', '<div><span style=\"color: rgb(0, 0, 0); font-family: Simsun; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: normal;\">精选优质阳光小麦粉，苏打饼香脆不粘牙，搭配柔滑香浓的乳酪夹心，更具风味。独立小包装，锁定风味，安全卫生，携带方便。</span><br></div>', '2018-03-29 16:31:06', 'https://detail.tmall.com/item.htm?spm=a1z10.3-b-s.w4011-15652746195.46.580d6e8ek6kQRc&id=542618977609&rn=73741f19863d0fcbad9ab48ca67a262f&abbucket=12', 5, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ni_1008_production_attrs_map`
--
...
--
-- Dumping data for table `ni_1008_production_attrs_map`
--
...
--
-- Table structure for table `ni_1008_types`
--
...
--
-- Dumping data for table `ni_1008_types`
--
...
--
-- Table structure for table `ni_cloud_filemeta_protected`
--
...
--
-- Table structure for table `ni_cloud_filemeta_public`
--
...
--
-- Dumping data for table `ni_cloud_filemeta_public`
--
...
('2a17ce03eec48c2d15236902785ad1ab26a80a5', 113, 5, 'ads(1).mp4', 'video', 1223196, 'mp4', '2018-04-14 15:17:58', '2018-04-14 15:17:58', 0),
...
('9ace07f0470515e815240140815ad69c021492e', 114, 5, 'logo.common_new.jpg', 'image', 47701, 'jpg', '2018-04-18 09:14:41', '2018-04-18 09:14:41', 0),
...
--
-- Table structure for table `ni_cloud_groups`
--
...
--
-- Dumping data for table `ni_cloud_groups`
--
...
--
-- Table structure for table `ni_cloud_sources_protected`
--
...
--
-- Table structure for table `ni_cloud_sources_public`
--
...
--
-- Dumping data for table `ni_cloud_sources_public`
--
...
(114, 'e1322aed9ace07f0470515e87bd0114e', 'Images/2018-04-18/e1322aed9ace07f0470515e87bd0114e.jpg', 'image/jpeg', 'width=\"294\" height=\"90\"', 294, 90, 0);
...
(6, 'job', 'positions', 0, '123456', '1234567', -7, '2018-03-06 13:49:14', 5, 0, 0, '2018-03-06 13:49:29', '2018-05-03 09:52:18', 1, 1),
(13, 'news', 'news', 1, '广东广播电视台《品牌观察》栏目专访来利洪食品集团', '2017年11月5日，关于来利洪食品集团的品牌宣传视频在广东广播电视台《品牌观察》栏目播出，约有近百万市民收看节目。《品牌观察》栏目立足广东，面向全国，是肩负“品牌强国”创业使命的官方电视台栏目，对各行业的国产品牌进行苛刻筛选，旨在挖掘国内优质品牌，与万千', -7, '2017-11-09 10:35:24', 7, 0, 0, '2018-03-09 10:37:45', '2018-04-03 23:19:54', 1, 0),
...
(27, 'news', 'news', 2, '我国饼干行业积极探索传统食品发展之道1', '寻找适合自身发展的突破口本报讯 （记者鲍小铁）由中国焙烤食品糖制品工业协会（以下简称“中焙糖协”）饼干专业委员会主办，广州刚奇包装有限公司承办的2017年中焙糖协饼干专业委员会理事会暨行业年会，于近日在广东省珠海市召开。中国轻工业联合会兼职副会长、中焙糖协', -7, '2018-01-29 16:51:29', 5, 0, 0, '2018-03-09 16:53:27', '2018-04-14 15:17:20', 1, 0),
...
(39, 'job', 'positions', 0, '财务经理', '1、分析检查公司财务收支和预算的执行情况；2、为生产经营会议、合同协议的签订等工作提供信息，参与决策；3、组织其他会计人员学习业务，积极为会计人员的调配晋升、聘任、辞退 等工作搞好服务；4、定期组织财务部人员与其他部门的账务核对工作，定期组织与客户核对往来', -7, '2018-03-16 09:56:15', 5, 0, 1, '2018-03-16 09:57:33', '2018-05-03 09:52:00', 1, 0),
...
--
-- Dumping data for table `ni_pageads_ads`
--
...
(3, '首页视频广告', 'video', '/applications/uploads/files/2a17ce03eec48c2d15236902785ad1ab26a80a5.mp4', '/productions/', 0, 0);
...
--
-- Dumping data for table `ni_pages_archives`
--
...
--
-- Dumping data for table `ni_pages_links`
--
...
(6, 0, 0, '联系我们', 'page', '12', '联系我们', 7, 1),
(22, 0, 0, '电商入口', 'http', 'https://lailihong.tmall.com/shop/view_shop.htm?spm=a230r.1.14.10.302430585DS3hG&user_number_id=3039509730', '', 6, 1);
...
--
-- Dumping data for table `ni_pages_pages`
--
...
--
-- Indexes for table `ni_1008_options`
--
ALTER TABLE `ni_1008_options`
...
--
-- AUTO_INCREMENT for table `ni_1008_brands`
--
ALTER TABLE `ni_1008_brands`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `ni_1008_categories`
--
ALTER TABLE `ni_1008_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ni_1008_category_attrs`
--
ALTER TABLE `ni_1008_category_attrs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ni_1008_productions`
--
ALTER TABLE `ni_1008_productions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT for table `ni_1008_types`
--
ALTER TABLE `ni_1008_types`
...
--
-- AUTO_INCREMENT for table `ni_cloud_groups`
--
ALTER TABLE `ni_cloud_groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ni_cloud_sources_protected`
--
ALTER TABLE `ni_cloud_sources_protected`
  MODIFY `SID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ni_cloud_sources_public`
--
ALTER TABLE `ni_cloud_sources_public`
