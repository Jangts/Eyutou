...
--
-- Host: localhost
-- Generation Time: 2018-04-02 20:49:12
-- 服务器版本： 5.5.54-log
-- PHP Version: 7.0.1
...
CREATE TABLE `ni_1008_brands` (
  `SK_SORT_NUM` int(11) NOT NULL DEFAULT '0',
  `id` int(11) NOT NULL,
...
INSERT INTO `ni_1008_brands` (`SK_SORT_NUM`, `id`, `category_id`, `brand_name`, `brand_logo`, `brand_desc`) VALUES
...
INSERT INTO `ni_1008_categories` (`SK_SORT_NUM`, `id`, `parent_id`, `category_name`, `category_desc`) VALUES
...
INSERT INTO `ni_1008_types` (`SK_SORT_NUM`, `id`, `brand_id`, `typename`) VALUES
(0, 2, 2, '月饼'),
(0, 8, 1, '苏打饼干'),
(0, 4, 2, '面包'),
(0, 9, 1, '玛德琳饼干'),
...
INSERT INTO `ni_cloud_groups` (`SK_SORT_NUM`, `id`, `tablename`, `name`, `description`, `parent`, `SK_IS_RECYCLED`, `SK_MTIME`) VALUES
